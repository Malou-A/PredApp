...
class SecondFrame:
    ...
    def __init__(self, root, channel, img):
        ...
        self.B6 = Button(self.root, text = "Back", command = lambda: MainWindow(self.root))
        self.B6.place(x = int(w*0.20/2), y = int(35+ h*0.88), anchor = "center", width = 150)

        self.B7 = Button(self.root, text = "Edit annotation", command = lambda: ThirdFrame(self.root, self.imagewindow.img, self.imagewindow.x0, self.imagewindow.x1, self.imagewindow.y0, self.imagewindow.y1, self.imagewindow.x0s, self.imagewindow.x1s, self.imagewindow.y0s, self.imagewindow.y1s, self.channel))
        self.B7.place(x=int(w*0.65), y = int(35+ h*0.88), anchor = "center")

        self.B8 = Button(self.root, text = "Exit", command = self.root.destroy)
        self.B8.place(x = 160 + int(w*0.20/2), y = int(35+ h*0.88), anchor = "center", width = 150)
...
class ThirdFrame:
    ...
    def __init__(self, root, img, x0, x1, y0, y1,x0s,x1s,y0s,y1s, channel):
        ...
        self.B4 = Button(self.root, text = "Back", command = lambda: SecondFrame(self.root, self.channel, self.img))
        self.B4.place(x = int(w*0.30/2), y = int(55+ h*0.88), anchor = "center", width = 150)

        self.B5 = Button(self.root, text = "Exit", command = self.root.destroy)
        self.B5.place(x = 160 + int(w*0.30/2), y = int(55+ h*0.88), anchor = "center", width = 150)
        ...
        boundaries = Checkbutton(self.root, text = "Show boundaries", variable = self.imagewindow.var4, command = self.imagewindow.check_function)
        boundaries.place(x = 0.9*w, y = int(h*0.40 + (im_frame_height/2) + 10))
